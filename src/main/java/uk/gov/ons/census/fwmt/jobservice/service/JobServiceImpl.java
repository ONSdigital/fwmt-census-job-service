...
public class JobServiceImpl implements JobService {
  ...
  @Override
  public void convertAndSendUpdate(UpdateFieldWorkerJobRequest updateJobRequest) throws GatewayException {
    final CometConverter cometConverter = cometConverters.get("Household");
    CasePauseRequest casePauseRequest = cometConverter.convertUpdate(updateJobRequest);
    gatewayEventManager.triggerEvent(String.valueOf(updateJobRequest.getCaseId()), COMET_UPDATE_SENT, LocalTime.now());
    cometRestClient.sendRequest(casePauseRequest, String.valueOf(updateJobRequest.getCaseId()));
    gatewayEventManager.triggerEvent(String.valueOf(updateJobRequest.getCaseId()), COMET_UPDATE_ACK, LocalTime.now());
  }
}
